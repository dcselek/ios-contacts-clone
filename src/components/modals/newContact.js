...
import { StyleSheet, Text, View, Pressable, Modal, TouchableOpacity, TextInput, TouchableHighlight, ScrollView, SafeAreaView, Animated, TouchableWithoutFeedback, Keyboard, Easing } from 'react-native';
                    ...
                    <View>
                        ...
                        <View>
                            <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 26 }}>
                                <Animated.View style={[styles.selectContainer, { borderBottomWidth: 0.7, borderBottomColor: "#3a3a3c", opacity: inputAnim, flexDirection: "row", alignItems: "center", transform: [{ scaleY: scaleAnim }, { translateY: inputAnim }, { translateX: slideLeft }] }]}>
                                    <Pressable onPress={() => slideL()}>
                                        <View style={[styles.selectIconContainer, { backgroundColor: "#ff3b30", marginLeft: 24 }]}>
                                ...
                                <Animated.View style={{ backgroundColor: "#ff3b30", opacity: inputAnim, transform: [{ scaleY: scaleAnim }, { scaleX: scaleClose }, { translateY: inputAnim }, { translateX: slideLeft }] }}>
                                    <Pressable onPress={() => {closeD(); setDeleteT("");}}>
                                        <View style={{ paddingVertical: 13, paddingHorizontal: 16, alignItems: 'center', justifyContent: 'center' }}>
                                            <Text style={{ fontSize: 16, color: "white", fontWeight: '500' }}>{deleteT}</Text>
                                        </View>
                                    </Pressable>
                                </Animated.View>
                            </View>
                            <Animated.View style={{ transform: [{ translateY: buttonAnim }] }}>
                                <TouchableHighlight style={[styles.selectContainer]} underlayColor='#3a3a3c' onPress={() => { upCome(); setDeleteT("Delete"); }}>
